...
from tests.providers.aws import SOME_AWS_REGIONS, fake_arn
...
class FakeSessionNoReport():
    """
    Fake Boto Session object with no reports defined.
...
class AWSReportDownloaderTest(MasuTestCase):
    ...
    @patch('masu.providers.aws.downloader.get_assume_role_session',
